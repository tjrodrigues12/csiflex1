...
Public Class Edit_logfile
    ...
    Function Myfunction() As String()
        Dim myArray_ As String() = Nothing
    ...
    Private Sub BT_OK_Click(sender As Object, e As EventArgs) Handles BT_Preview.Click
    ...
    Private Sub BT_SCAN_CYCLEON_Click(sender As Object, e As EventArgs) Handles BT_SCAN_CYCLEON.Click
    ...
    Private Sub BT_SCAN_CYCLEOFF_Click(sender As Object, e As EventArgs) Handles BT_SCAN_CYCLEOFF.Click
        ...
        For i = 0 To tbldistinct.Rows.Count - 1
            CB_CYCLEOFF.Items.Add(tbldistinct.Rows(i).Item(0).ToString)
        Next
    End Sub
