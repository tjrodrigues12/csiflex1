    ...
    Public Sub generateReportPDF()
        If Not (tb_pathReport.Text = "") Then
            ...
            If (RB_Week.Checked) Then
                setEvent("ww")
                CSI_Lib.generateReport(read_tree(), "Weekly", DTP_Start.Value, DTP_End.Value, tb_pathReport.Text, SEvent, False, "False")
            End If

            If (RB_Month.Checked) Then
                setEvent("m")
                CSI_Lib.generateReport(read_tree(), "Monthly", DTP_Start.Value, DTP_End.Value, tb_pathReport.Text, SEvent, False, "False")
            End If

            If (RB_Day.Checked) Then
                setEvent("y")
                CSI_Lib.generateReport(read_tree(), "Daily", DTP_Start.Value, DTP_End.Value, tb_pathReport.Text, SEvent, False, "False")
            End If
