...
Public Class WeeklyReport
    ...
    Public Sub Periode(dt1 As Date, dt2 As Date, periode_ As String)
        ...
        For Each items In active_machines
            ...
            loop_ = True
            For column_ = 1 To 89
                active_machines(i) = New CSI_Library.CSI_Library().RenameMachine(active_machines(i))
                ...
                If Config_report.DTP_StartDate.Value.Date = Config_report.DTP_EndDate.Value.Date Then
                ...
                Else
                    If Config_report.DTP_StartDate.Value.Day = 1 And Config_report.DTP_EndDate.Value.Day = System.DateTime.DaysInMonth(Config_report.DTP_EndDate.Value.Year, Config_report.DTP_EndDate.Value.Month) Then
                        Date_ = SetupForm.mois_(Config_report.DTP_StartDate.Value.Month) & " " & Config_report.DTP_StartDate.Value.Year
                    Else
                        If Config_report.DTP_StartDate.Value.Year = Config_report.DTP_EndDate.Value.Year Then

                            Date_ = Config_report.DTP_StartDate.Value.Day & " " & SetupForm.mois_(Config_report.DTP_StartDate.Value.Month) & " to " & Config_report.DTP_EndDate.Value.Day & " " & SetupForm.mois_(Config_report.DTP_EndDate.Value.Month) & " " & (Config_report.DTP_EndDate.Value.Year)
                        Else
                            Date_ = Config_report.DTP_StartDate.Value.Day & " " & SetupForm.mois_(Config_report.DTP_StartDate.Value.Month) & " " & (Config_report.DTP_StartDate.Value.Year) & " to " & Config_report.DTP_EndDate.Value.Day & " " & SetupForm.mois_(Config_report.DTP_EndDate.Value.Month) & " " & (Config_report.DTP_EndDate.Value.Year)
                        End If
                    End If
                End If
                ...
                Else
                    ...
                    If first_ = True Then
                        If day_end >= Config_report.DTP_EndDate.Value.DayOfWeek + Val(Reporting_application.week_(1)) Then
                            day_end = day_end - Config_report.DTP_EndDate.Value.DayOfWeek + Val(Reporting_application.week_(1))
                        ...
                        Else
                            If month_end <> 1 Then
                                ...
                                day_end = System.DateTime.DaysInMonth(year_end + 2000, month_end) - Config_report.DTP_EndDate.Value.DayOfWeek + Val(Reporting_application.week_(1)) + 1
                            Else
                                month_end = 12
                                year_end = year_end - 1
                                day_end = System.DateTime.DaysInMonth(year_end + 2000, month_end) - Config_report.DTP_EndDate.Value.DayOfWeek + Val(Reporting_application.week_(1)) + 1
