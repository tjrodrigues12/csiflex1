...
Public Class Report_PieChart
    ...
    Private Sub Report_PieChart_close(sender As Object, e As EventArgs) Handles MyBase.FormClosing
        ...
        If formshift1.Visible = True Then formshift1.Close()
    ...
    Private Sub CB_Report_SelectedIndexChanged(sender As Object, e As EventArgs) Handles CB_Report.SelectedIndexChanged
        ...
        Try
            ...
            If Report_BarChart.Pie_chart_source = 0 Then
                ...
                If CSI_LIB.RenameMachine(machine) = Text(0) And date_ = Text(1) Then
...
good:
        ...
        Catch ex As Exception
            ...
            CSI_LIB.LogClientError("shift det error : " & ex.Message)
        End Try
            ...
            If Not CB_Report.SelectedText.StartsWith("consolidated") Then
                ...
                Else
                    ...
                    Else
                        ...
                        formshift1.Location = Reporting_application.Location + New Point(Me.Location.X + DataGridView1.Location.X + Panel2.Location.X, Me.Location.Y + DataGridView1.Location.Y + Panel2.Location.Y)
