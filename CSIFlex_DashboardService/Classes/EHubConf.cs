        ...
        public void updateIfNoPartNo(string[] l1_final, string filenames, int r1, int p1, int q1)
        {
            ...
            if (dttable2.Rows.Count == 0)
            {
                ...
                if (dtgetlastcyclefromMonsetup.Rows.Count > 0)
                {
                    ...
                    string query_monsetup_update = "UPDATE IGNORE csi_dashboard.tbl_monsetup_data SET current_status_='" + l1_final[r1] + "',last_cycle_time='" + old_last_cycle_time + "',elapsed_time='" + difference + "',correction_date_='" + formatForMySql + "' WHERE machine_tmp_filename_ ='" + filenames + ".SYS_';";
                ...
                if (dttable3.Rows.Count == 0) //This means record  not exists previously
                {
                        ...
                        { /* HERE WE NEED TO ADD CODE FOR CYCLE COUNT AND CYCLE MULTIPLIER
                          ...
                          */
                             ...
                             //DateTime date1 = DateTime.ParseExact(datetime1, "MM/dd/yy HH:mm:ss", CultureInfo.InvariantCulture); //DateTime.Parse(datetime1);
                                ...
                                string updatemon = "UPDATE IGNORE csi_dashboard.tbl_monsetup_data SET old_last_cycle_time = '" + newpreviouscycle + "', current_status_='" + l1_final[r1] + "',last_cycle_time='" + prevlastcycle + "',elapsed_time='" + difference1 + "',correction_date_='" + formatForMySql + "'  WHERE machine_tmp_filename_='" + filenames + ".SYS_'";
                            ...
                            else
                            {
                                ...
                                string query_monsetup_update = "UPDATE IGNORE csi_dashboard.tbl_monsetup_data SET current_status_='" + l1_final[r1] + "',last_cycle_time='" + prevlastcycle + "',elapsed_time='" + difference1 + "',correction_date_='" + formatForMySql + "' WHERE machine_tmp_filename_ ='" + filenames + ".SYS_';";
                    ...
                    { //Add code here This Means we dont have previous record where we have status Change last_cycle_time here 
                        ...
                        if (dtgetlastcyclefromMonsetup.Rows.Count > 0)
                        {
                            ...
                            string query_monsetup_update = "UPDATE IGNORE csi_dashboard.tbl_monsetup_data SET current_status_='" + l1_final[r1] + "',last_cycle_time='" + old_last_cycle_time + "',elapsed_time='" + difference2 + "',correction_date_='" + formatForMySql + "' WHERE machine_tmp_filename_ ='" + filenames + ".SYS_';";
