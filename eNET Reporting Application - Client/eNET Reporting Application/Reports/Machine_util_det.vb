Public Class Machine_util_det
    ...
    Private Sub Machine_util_det_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        index_selected = Report_BarChart.cBoxReports.SelectedIndex
        ...
        Me.Location = New Point(Report_BarChart.Size.Width + Config_report.Size.Width + Config_report.Location.X, Report_BarChart.Location.Y)
