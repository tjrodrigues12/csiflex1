...
Public Class PartNumberControl
    ...
    Private Sub PartNumberControl_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        For Each row As DataRow In tbPartNumbers.Rows
            ...
            gridItem.CreatedBy = IIf(Not IsDBNull(row("UserDisplayName")), row("UserDisplayName"), "")
        ...
        btnNew.Enabled = CSI_Library.CSI_Library.userEditPartNumbers
        btnEdit.Enabled = CSI_Library.CSI_Library.userEditPartNumbers
        btnDelete.Enabled = CSI_Library.CSI_Library.userEditPartNumbers
    ...
    Private Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        ...
        GridItem.CreatedBy = CSI_Library.CSI_Library.username
        ...
        Try
            If partNumberId = 0 And Not regExists Then
                ...
                query.Append($"     '{CSI_Library.CSI_Library.userid}'          ")
                query.Append($" )                                               ")
