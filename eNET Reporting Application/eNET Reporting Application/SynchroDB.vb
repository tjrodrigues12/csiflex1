...
Public Class SynchroDB
    ...
    ByVal e As DoWorkEventArgs)
        ...
        'synchroDBuser()
        'createReplicaOfDB()
        'If File.Exists(Forms.Application.StartupPath & "\sys\Setupdb_.csys") Then
        '    Using writer As StreamReader = New StreamReader(Forms.Application.StartupPath & "\sys\Setupdb_.csys")
