...
Public Class Report
    ...
    Dim csi_lib As New CSI_Library
    ...
    Private Sub GenerateReport()
        ...
        Try
            csi_lib.LogServiceError("generating report---:" + _report_id + " at " + Now.ToString(), 1)


            Dim fileToSend_ As String = csi_lib.generateReport(_report_machines, _report_type, _report_startdate, _report_enddate, _report_folder, _report_events, True, _report_id)
        ...
        Try
            ...
            Else
                csi_lib.LogServiceError("Report not sent: pb with _report_mailto or fileToSend.", 1)
            End If
        Catch ex As Exception
