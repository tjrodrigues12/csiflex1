    ...
    xhttp.onreadystatechange = function () {
        if (xhttp.readyState == 4 && xhttp.status == 200) {
            ...
            if (JSONserverResponse.config === undefined || JSONserverResponse.config.length <= 0 || JSONserverResponse.COLORS.length <= 0) {
                ...
                groupsDefinition["All machines"] = JSONserverResponse.tbl_device_machines_groups[0].machines.split(', ')
                ...
                var grouplist = JSONserverResponse.tbl_device_machines_groups[0].groups;
                if (grouplist === null) 
                {
                    grouplist = null;
                } 
                ...
                setweeklyMonthlyMachinesStatusHashmap(JSONserverResponse.perf,grouplist);
